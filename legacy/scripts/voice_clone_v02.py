...
import soundfile
import pygame
from module.mel_processing import spectrogram_torch  # 从原始代码导入

# 全局变量
device = "cuda" if torch.cuda.is_available() else "cpu"
is_half = torch.cuda.is_available()
hps = None  # 全局存储 SoVITS 配置
...
if __name__ == "__main__":
    ...
    ref_wav_path = "output4/changli_001.wav"
    prompt_text = "难得你有闲下来我这里,我正巧处理完事务,若是不急著走,便来与我手谈一局吧。"
    text = "大家好，今天天气很好。"
